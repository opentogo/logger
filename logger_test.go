...
func TestLogger(t *testing.T) {
	...
	t.Run("logging with referer and user-agent data", func(t *testing.T) {
		...
		logger.Handler(mux)(w, r)
		assert.Equal(t, "127.0.0.1 - - [01/Jan/1980:12:12:12 +0000] \"GET http://example.com HTTP/1.1\" 301 54 \"http://example.com\" \"go/testing\" 0.0000\n", buf.String())
	})
	...
	t.Run("logging with encoded request", func(t *testing.T) {
		...
		logger.Handler(mux)(w, r)
		assert.Equal(t, "127.0.0.1 - - [01/Jan/1980:12:12:12 +0000] \"GET http://example.com HTTP/1.1\" 404 73 \"http://example.com\" \"go/testing\" 0.0000\n", buf.String())
	})
	...
	t.Run("logging with connect method", func(t *testing.T) {
		...
		logger.Handler(mux)(w, r)
		assert.Equal(t, "127.0.0.1 - - [01/Jan/1980:12:12:12 +0000] \"CONNECT www.example.com:443 HTTP/2.0\" 404 92 \"http://example.com\" \"go/testing\" 0.0000\n", buf.String())
	})
}
